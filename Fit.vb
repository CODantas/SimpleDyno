...
#End If
    ...
    Sub WritePowerFile()
        ...
        With DataOutputFile
            ...
            .WriteLine("Channel_1_Threshold: " & Main.HighSignalThreshold.ToString(System.Globalization.CultureInfo.InvariantCulture))
            .WriteLine("Channel_2_Threshold: " & Main.HighSignalThreshold2.ToString(System.Globalization.CultureInfo.InvariantCulture))
            .WriteLine("Run_RPM_Threshold: " & Main.PowerRunThreshold.ToString(System.Globalization.CultureInfo.InvariantCulture))
            .WriteLine("Run_Spike_Removal_Threshold: " & PowerRunSpikeLevel.ToString(System.Globalization.CultureInfo.InvariantCulture))
